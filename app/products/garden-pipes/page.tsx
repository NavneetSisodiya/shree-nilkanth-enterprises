...
export default function GardenPipesPage() {
  const specifications = [
    { size: "1/2 Inch", pressure: "2.5 kg/cm²", length: "30m" },
    { size: "3/4 Inch", pressure: "2.5 kg/cm²", length: "30m" },
    { size: "1 Inch", pressure: "2.5 kg/cm²", length: "30m" },
  ];
      ...
      <section className="bg-gradient-to-br from-blue-900 to-gray-800 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Garden Pipes</h1>
            <p className="text-xl text-gray-200">
              Flexible and lightweight pipes ideal for domestic and garden water applications.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-800 mb-6">Premium Garden Pipes</h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Our garden pipes are made from high-quality PVC material, ensuring flexibility, durability, and ease of use. These pipes are suitable for residential gardening, car washing, and general water delivery needs.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                With excellent UV resistance and weatherproof properties, these pipes are built to withstand everyday use in all seasons.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
             Garden Pipes | Flexibility & Strength | Leakproof Technology
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our Garden pipes are suitable for a wide range of applications across various industries.
            </p>
          </div>
